 ...
 * kernelsu.js — vendored `kernelsu` npm library v3.0.2 (exact upstream).
 *
 * Source: https://www.npmjs.com/package/kernelsu (ESM only)
 * Why vendored: the KernelSU WebUI runs in the manager's WebView and imports
 * from 'kernelsu'. Vendoring removes the npm build step entirely — the module
 * zip ships app.js importing './kernelsu.js'.
 *
 * Do not hand-edit; replace with `npm i kernelsu` + copy the dist file when
 * bumping KernelSU manager baseline.
 */
